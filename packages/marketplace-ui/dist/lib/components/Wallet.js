...
exports.Wallet = exports.getToken = exports.DEFAULT_ENDPOINT = void 0;
const wallet_adapter_react_1 = require("@solana/wallet-adapter-react");
const wallet_adapter_wallets_1 = require("@solana/wallet-adapter-wallets");
const react_1 = __importStar(require("react"));
const constants_1 = require("../constants");
const hooks_1 = require("../hooks");
exports.DEFAULT_ENDPOINT = constants_1.SOLANA_URL;
...
const Wallet = ({ children, cluster, }) => {
    const { endpoint } = (0, hooks_1.useEndpoint)();
    ...
    const wallets = (0, react_1.useMemo)(() => [
        ...
        new wallet_adapter_wallets_1.SolletExtensionWalletAdapter({}),
    ], []);
