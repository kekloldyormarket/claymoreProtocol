...
const RadioCard = (_a) => {
    var { children, disabled = false } = _a, props = __rest(_a, ["children", "disabled"]);
    ...
    return (react_1.default.createElement(react_2.Box, { onClick: (e) => {
        ...
        react_1.default.createElement(react_2.Box, { as: "label" },
            ...
            react_1.default.createElement(react_2.Box, Object.assign({}, checkbox, { mt: { base: 2, md: 0 }, mr: 2, cursor: "pointer", borderWidth: "1px", borderRadius: "md", bg: "gray.200", _checked: {
                    bg: "orange.600",
                    color: "white",
...
const RadioCardWithAffordance = (_a) => {
    ...
    const input = getInputProps();
    const checkbox = getCheckboxProps();
    return (react_1.default.createElement(react_2.Box, { w: "full", maxW: { base: "auto", md: "242px" }, flexGrow: 1, flexShrink: 1, flexBasis: 0, onClick: (e) => {
            if (disabled) {
                e.preventDefault();
                e.stopPropagation();
            }
        ...
        react_1.default.createElement(react_2.Box, { as: "label", textAlign: "center" },
            react_1.default.createElement("input", Object.assign({}, input)),
            react_1.default.createElement(react_2.Stack, Object.assign({}, checkbox, { cursor: disabled ? "inherit" : "pointer", opacity: disabled ? 0.4 : 1, borderWidth: "1px", borderRadius: "md", h: "full", bg: "white", borderColor: "white", position: "relative", px: 4, py: 4, mb: 2, _hover: disabled
                    ? {}
                    : {
                ...
                react_1.default.createElement(react_2.Flex, { justifyContent: "right", position: "absolute", top: 2, right: 2 },
