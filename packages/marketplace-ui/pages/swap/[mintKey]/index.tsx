...
import { Box, BoxProps, Center, Container, Heading, Spinner, Stack } from "@chakra-ui/react";
import {
  Swap,
  usePublicKey,
...
<BigText>
 <BlackBox w="full" position="relative">{numberWithCommas(staked, 4)} </BlackBox> Staked
